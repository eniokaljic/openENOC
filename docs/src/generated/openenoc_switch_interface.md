...
Don't override. Generated from: openenoc_switch_interface_top
  - /home/enio/Projects/openENOC/hal/interfaces/openenoc_switch_interface.rdl
-->
...
<p>Control and status address map for an openENOC Switch instance.</p>

|Offset|        Identifier       |           Name          |
|------|-------------------------|-------------------------|
|  0x0 |openenoc_switch_interface|openenoc_switch_interface|

## openenoc_switch_interface register file
...
|Offset|    Identifier    |                    Name                    |
|------|------------------|--------------------------------------------|
| 0x00 |       info       |       openenoc_switch_interface.info       |
| 0x04 |forwarding_control|openenoc_switch_interface.forwarding_control|
| 0x08 |default_forwarding|openenoc_switch_interface.default_forwarding|
| 0x10 | forwarding_table | openenoc_switch_interface.forwarding_table |
...
|-----|-----------------|------|-----|-------------------------------------------------------|
| 15:0|   table_depth   |   r  | 0x1 |    openenoc_switch_interface.info.table_depth[15:0]   |
|21:16|num_of_interfaces|   r  | 0x1 |openenoc_switch_interface.info.num_of_interfaces[21:16]|
...
|Bits|  Identifier  |Access|Reset|                              Name                              |
|----|--------------|------|-----|----------------------------------------------------------------|
|  0 |operation_mode|  rw  | 0x0 |openenoc_switch_interface.forwarding_control.operation_mode[0:0]|
|  7 | pause_request|  rw  | 0x0 | openenoc_switch_interface.forwarding_control.pause_request[7:7]|
| 15 |  pause_done  |   r  |  —  | openenoc_switch_interface.forwarding_control.pause_done[15:15] |
...
|Bits|Identifier|Access|Reset|                                   Name                                   |
|----|----------|------|-----|--------------------------------------------------------------------------|
|  0 |  bitmap  |  rw  | 0x0 |openenoc_switch_interface.default_forwarding.bitmap[NUM_OF_INTERFACES-1:0]|
...
|Offset|Identifier|                               Name                               |
|------|----------|------------------------------------------------------------------|
|  0x0 | entry[0] |openenoc_switch_interface.forwarding_table.entry[0..TABLE_DEPTH-1]|
...
|Offset| Identifier|                                     Name                                     |
|------|-----------|------------------------------------------------------------------------------|
|  0x0 |mac_address|openenoc_switch_interface.forwarding_table.entry[0..TABLE_DEPTH-1].mac_address|
|  0x8 |   iface   |   openenoc_switch_interface.forwarding_table.entry[0..TABLE_DEPTH-1].iface   |
|  0xC |   config  |   openenoc_switch_interface.forwarding_table.entry[0..TABLE_DEPTH-1].config  |
...
| Bits|Identifier|Access|Reset|                                             Name                                            |
|-----|----------|------|-----|---------------------------------------------------------------------------------------------|
| 31:0|  lo_word |  rw  |  —  | openenoc_switch_interface.forwarding_table.entry[0..TABLE_DEPTH-1].mac_address.lo_word[31:0]|
|47:32|  hi_word |  rw  |  —  |openenoc_switch_interface.forwarding_table.entry[0..TABLE_DEPTH-1].mac_address.hi_word[47:32]|
...
|Bits|Identifier|Access|Reset|                                                 Name                                                 |
|----|----------|------|-----|------------------------------------------------------------------------------------------------------|
|  0 |  bitmap  |  rw  |  —  |openenoc_switch_interface.forwarding_table.entry[0..TABLE_DEPTH-1].iface.bitmap[NUM_OF_INTERFACES-1:0]|
...
|Bits|Identifier|Access|Reset|                                       Name                                      |
|----|----------|------|-----|---------------------------------------------------------------------------------|
|  0 |  enabled |  rw  |  —  |openenoc_switch_interface.forwarding_table.entry[0..TABLE_DEPTH-1].config.enabled|
