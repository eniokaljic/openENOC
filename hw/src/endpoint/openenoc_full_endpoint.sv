...
/*
 * openENOC full endpoint including PicoRV32 CPU, instruction/data memories, and generated CSR block
 */
module openenoc_full_endpoint #
(
...
(
    ...
    input  openenoc_full_endpoint_csr_pkg::openenoc_full_endpoint_csr__in_t  hwif_in,
    output openenoc_full_endpoint_csr_pkg::openenoc_full_endpoint_csr__out_t hwif_out,
    ...
    localparam AXIL_DATA_W = openenoc_full_endpoint_pkg::OPENENOC_FULL_ENDPOINT_DATA_WIDTH;
    localparam AXIL_STRB_W = AXIL_DATA_W/8;

    localparam IMEM_ADDR_W = $clog2(
        openenoc_full_endpoint_pkg::IMEM_DEPTH * AXIL_STRB_W
    );
    localparam DMEM_ADDR_W = $clog2(
        openenoc_full_endpoint_pkg::DMEM_DEPTH * AXIL_STRB_W
    );
    localparam CSR_ADDR_W =
        openenoc_full_endpoint_csr_pkg::OPENENOC_FULL_ENDPOINT_CSR_MIN_ADDR_WIDTH;
    ...
    */
    localparam AXIL_TARGET_BASE_ADDR = {
        AXIL_ADDR_W'(openenoc_full_endpoint_pkg::CSR_BASE_ADDR),
        AXIL_ADDR_W'(openenoc_full_endpoint_pkg::IMEM_BASE_ADDR),
        AXIL_ADDR_W'(openenoc_full_endpoint_pkg::DMEM_BASE_ADDR)
    };
    ...
    if (AXIL_DATA_W !=
            openenoc_full_endpoint_csr_pkg::OPENENOC_FULL_ENDPOINT_CSR_DATA_WIDTH) begin : g_csr_data_width_error
        $fatal(0, "Error: endpoint and CSR data widths do not match (instance %m)");
    end

    if (2**$clog2(openenoc_full_endpoint_pkg::IMEM_DEPTH) !=
            openenoc_full_endpoint_pkg::IMEM_DEPTH) begin : g_imem_depth_error
        $fatal(0, "Error: IMEM depth must be a power of two (instance %m)");
    end

    if (2**$clog2(openenoc_full_endpoint_pkg::DMEM_DEPTH) !=
            openenoc_full_endpoint_pkg::DMEM_DEPTH) begin : g_dmem_depth_error
    ...
    */
    ...
    picorv32_axi #(
        .PROGADDR_RESET (AXIL_ADDR_W'(openenoc_full_endpoint_pkg::IMEM_BASE_ADDR)),
        .STACKADDR      (AXIL_ADDR_W'(
            openenoc_full_endpoint_pkg::DMEM_BASE_ADDR +
            openenoc_full_endpoint_pkg::DMEM_DEPTH * AXIL_STRB_W
        ))
    )
    cpu_inst (
    ...
    */
    ...
    openenoc_full_endpoint_csr csr_inst (
        .clk            (clk),
        .rst            (rst),
