...
class openENOC_csr_single_access(openENOC_TestCase): # type: ignore[valid-type,misc]
    ...
    def test_user_defined_properties(self)  -> None:
        ...
        """
        with self.subTest(msg='register: openENOC.csr.test_reg'):
            
            
            self.assertDictEqual(self.dut.csr.test_reg.udp,{})
            
        with self.subTest(msg='register: openENOC.csr.test_reg.test_field'):
            
            
            self.assertDictEqual(self.dut.csr.test_reg.test_field.udp,{})
    ...
    def test_register(self) -> None:
        ...
        """
        with self.subTest(msg='register: openENOC.csr.test_reg'):
            self._single_register_property_test(rut=self.dut.csr.test_reg, address=536870912, width=32, accesswidth=32, size=4,
                                                rdl_name="csr.test_reg",
                                                rdl_desc="Test register",
                                                inst_name='test_reg',
                                                parent_full_inst_name='openENOC.csr')
            self._single_register_read_and_write_test(rut=self.dut.csr.test_reg, has_sw_readable=True, has_sw_writable=True,
    ...
    def test_field(self) -> None:
        ...
        with self.subTest(msg='field: openENOC.csr.test_reg.test_field'):
            self._single_field_property_test(fut=self.dut.csr.test_reg.test_field, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=0,
                                             rdl_name="csr.test_reg.test_field[31:0]",
                                             rdl_desc="4-byte test field",
                                             inst_name='test_field',
                                             parent_full_inst_name='openENOC.csr.test_reg')
            self._single_int_field_read_and_write_test(fut=self.dut.csr.test_reg.test_field, is_sw_readable=True, is_sw_writable=True)
...
class openENOC_csr_block_access(openENOC_TestCase_BlockAccess): # type: ignore[valid-type,misc]
    """
...
class openENOC_csr_alt_block_access(openENOC_TestCase_AltBlockAccess): # type: ignore[valid-type,misc]
    """
