...
class openenoc_csr_simulator_cls(Simulator):
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch1.default_forwarding', readable=True, writable=True,
            ...
            384 : 
    Register(width=64, full_inst_name='openenoc_csr.switch1.forwarding_table.entry[0].macaddr', readable=True, writable=True,
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch1.forwarding_table.entry[0].config', readable=True, writable=True,
            ...
            400 : 
    Register(width=64, full_inst_name='openenoc_csr.switch1.forwarding_table.entry[1].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            408 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch1.forwarding_table.entry[1].config', readable=True, writable=True,
            ...
            416 : 
    Register(width=64, full_inst_name='openenoc_csr.switch1.forwarding_table.entry[2].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            424 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch1.forwarding_table.entry[2].config', readable=True, writable=True,
            ...
            432 : 
    Register(width=64, full_inst_name='openenoc_csr.switch1.forwarding_table.entry[3].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            440 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch1.forwarding_table.entry[3].config', readable=True, writable=True,
            ...
            448 : 
    Register(width=64, full_inst_name='openenoc_csr.switch1.forwarding_table.entry[4].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            456 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch1.forwarding_table.entry[4].config', readable=True, writable=True,
            ...
            464 : 
    Register(width=64, full_inst_name='openenoc_csr.switch1.forwarding_table.entry[5].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            472 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch1.forwarding_table.entry[5].config', readable=True, writable=True,
            ...
            480 : 
    Register(width=64, full_inst_name='openenoc_csr.switch1.forwarding_table.entry[6].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            488 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch1.forwarding_table.entry[6].config', readable=True, writable=True,
            ...
            496 : 
    Register(width=64, full_inst_name='openenoc_csr.switch1.forwarding_table.entry[7].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            504 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.default_forwarding', readable=True, writable=True,
            ...
            1536 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[0].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1544 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[0].config', readable=True, writable=True,
            ...
            1552 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[1].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1560 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[1].config', readable=True, writable=True,
            ...
            1568 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[2].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1576 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[2].config', readable=True, writable=True,
            ...
            1584 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[3].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1592 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[3].config', readable=True, writable=True,
            ...
            1600 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[4].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1608 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[4].config', readable=True, writable=True,
            ...
            1616 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[5].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1624 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[5].config', readable=True, writable=True,
            ...
            1632 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[6].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1640 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[6].config', readable=True, writable=True,
            ...
            1648 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[7].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1656 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[7].config', readable=True, writable=True,
            ...
            1664 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[8].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1672 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[8].config', readable=True, writable=True,
            ...
            1680 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[9].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1688 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[9].config', readable=True, writable=True,
            ...
            1696 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[10].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1704 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[10].config', readable=True, writable=True,
            ...
            1712 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[11].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1720 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[11].config', readable=True, writable=True,
            ...
            1728 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[12].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1736 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[12].config', readable=True, writable=True,
            ...
            1744 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[13].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1752 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[13].config', readable=True, writable=True,
            ...
            1760 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[14].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1768 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[14].config', readable=True, writable=True,
            ...
            1776 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[15].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1784 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[15].config', readable=True, writable=True,
            ...
            1792 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[16].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1800 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[16].config', readable=True, writable=True,
            ...
            1808 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[17].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1816 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[17].config', readable=True, writable=True,
            ...
            1824 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[18].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1832 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[18].config', readable=True, writable=True,
            ...
            1840 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[19].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1848 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[19].config', readable=True, writable=True,
            ...
            1856 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[20].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1864 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[20].config', readable=True, writable=True,
            ...
            1872 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[21].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1880 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[21].config', readable=True, writable=True,
            ...
            1888 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[22].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1896 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[22].config', readable=True, writable=True,
            ...
            1904 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[23].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1912 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[23].config', readable=True, writable=True,
            ...
            1920 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[24].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1928 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[24].config', readable=True, writable=True,
            ...
            1936 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[25].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1944 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[25].config', readable=True, writable=True,
            ...
            1952 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[26].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1960 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[26].config', readable=True, writable=True,
            ...
            1968 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[27].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1976 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[27].config', readable=True, writable=True,
            ...
            1984 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[28].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            1992 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[28].config', readable=True, writable=True,
            ...
            2000 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[29].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            2008 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[29].config', readable=True, writable=True,
            ...
            2016 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[30].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            2024 : 
    ...
    Register(width=32, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[30].config', readable=True, writable=True,
            ...
            2032 : 
    Register(width=64, full_inst_name='openenoc_csr.switch2.forwarding_table.entry[31].macaddr', readable=True, writable=True,
                                         fields=[FieldDefinition(high=31, low=0, msb=31, lsb=0, inst_name='lo_word', field_type=FieldType.READWRITE),FieldDefinition(high=47, low=32, msb=47, lsb=32, inst_name='hi_word', field_type=FieldType.READWRITE),
                                                ]),
            2040 : 
