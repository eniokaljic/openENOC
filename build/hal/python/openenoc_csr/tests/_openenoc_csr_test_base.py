...
class openenoc_csr_TestCase(TestCaseBase): # type: ignore[valid-type,misc]
...
class openenoc_csr_TestCase_BlockAccess(BlockTestBase): # type: ignore[valid-type,misc]
...
class openenoc_csr_TestCase_AltBlockAccess(BlockTestBase): # type: ignore[valid-type,misc]
    """
