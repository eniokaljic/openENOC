...
class openenoc_csr_endpoint1_block_access(openenoc_csr_SimTestCase_BlockAccess): # type: ignore[valid-type,misc]
    """
    ...
    def test_memory_read_and_write(self) -> None:
        ...
        self.assertEqual(self.dut.endpoint1.rmem.read(start_entry=0, number_entries=entries_to_test), # type: ignore[union-attr]
                         random_data)
