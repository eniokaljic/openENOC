...
class openenoc_csr_endpoint2_single_access(openenoc_csr_TestCase): # type: ignore[valid-type,misc]
    ...
    def test_user_defined_properties(self)  -> None:
        ...
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.source'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.source.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.sink'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.sink.udp,{})
        ...
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.source.data'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.source.data.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.source.control'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.source.control.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.source.status'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.source.status.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.sink.data'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.sink.data.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.sink.control'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.sink.control.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.sink.status'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.sink.status.udp,{})
        ...
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[0].dma'):
            
            
            self.assertDictEqual(self.dut.endpoint2.peers.entry[0].dma.udp,{})
        ...
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[1].dma'):
            
            
            self.assertDictEqual(self.dut.endpoint2.peers.entry[1].dma.udp,{})
        ...
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.source.data.tdata'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.source.data.tdata.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.source.control.tvalid'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.source.control.tvalid.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.source.control.tlast'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.source.control.tlast.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.source.status.tready'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.source.status.tready.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.sink.data.tdata'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.sink.data.tdata.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.sink.control.tready'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.sink.control.tready.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.sink.status.tvalid'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.sink.status.tvalid.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.sink.status.tlast'):
            
            
            self.assertDictEqual(self.dut.endpoint2.axis_if.sink.status.tlast.udp,{})
        ...
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[0].size.bytes'):
            
            
            self.assertDictEqual(self.dut.endpoint2.peers.entry[0].register_size.bytes.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[0].dma.mode'):
            
            
            self.assertDictEqual(self.dut.endpoint2.peers.entry[0].dma.mode.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[0].dma.request'):
            
            
            self.assertDictEqual(self.dut.endpoint2.peers.entry[0].dma.request.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[0].dma.idle'):
            
            
            self.assertDictEqual(self.dut.endpoint2.peers.entry[0].dma.idle.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[0].dma.done'):
            
            
            self.assertDictEqual(self.dut.endpoint2.peers.entry[0].dma.done.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[0].dma.error'):
            
            
            self.assertDictEqual(self.dut.endpoint2.peers.entry[0].dma.error.udp,{})
        ...
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[1].size.bytes'):
            
            
            self.assertDictEqual(self.dut.endpoint2.peers.entry[1].register_size.bytes.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[1].dma.mode'):
            
            
            self.assertDictEqual(self.dut.endpoint2.peers.entry[1].dma.mode.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[1].dma.request'):
            
            
            self.assertDictEqual(self.dut.endpoint2.peers.entry[1].dma.request.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[1].dma.idle'):
            
            
            self.assertDictEqual(self.dut.endpoint2.peers.entry[1].dma.idle.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[1].dma.done'):
            
            
            self.assertDictEqual(self.dut.endpoint2.peers.entry[1].dma.done.udp,{})
            
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[1].dma.error'):
            
            
            self.assertDictEqual(self.dut.endpoint2.peers.entry[1].dma.error.udp,{})
    ...
    def test_register(self) -> None:
        ...
        """
        with self.subTest(msg='register: openenoc_csr.endpoint2.info'):
            self._single_register_property_test(rut=self.dut.endpoint2.info, address=4096, width=64, accesswidth=32, size=8,
        ...
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.source.data'):
            self._single_register_property_test(rut=self.dut.endpoint2.axis_if.source.data, address=4128, width=32, accesswidth=32, size=4,
                                                rdl_name="csr.endpoint2.axis_if.source.data",
                                                rdl_desc="Data register for the AXI4-Stream source interface.",
                                                inst_name='data',
                                                parent_full_inst_name='openenoc_csr.endpoint2.axis_if.source')
            self._single_register_read_and_write_test(rut=self.dut.endpoint2.axis_if.source.data, has_sw_readable=True, has_sw_writable=True,
                                                                                          readable_fields=set(['tdata', ]),
                                                                                          writeable_fields=set(['tdata', ]) )
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.source.control'):
            self._single_register_property_test(rut=self.dut.endpoint2.axis_if.source.control, address=4132, width=32, accesswidth=32, size=4,
                                                rdl_name="csr.endpoint2.axis_if.source.control",
                                                rdl_desc="Control register for the AXI4-Stream source interface.",
                                                inst_name='control',
                                                parent_full_inst_name='openenoc_csr.endpoint2.axis_if.source')
            self._single_register_read_and_write_test(rut=self.dut.endpoint2.axis_if.source.control, has_sw_readable=True, has_sw_writable=True,
                                                                                          readable_fields=set(['tvalid','tlast', ]),
                                                                                          writeable_fields=set(['tvalid','tlast', ]) )
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.source.status'):
            self._single_register_property_test(rut=self.dut.endpoint2.axis_if.source.status, address=4136, width=32, accesswidth=32, size=4,
                                                rdl_name="csr.endpoint2.axis_if.source.status",
                                                rdl_desc="Status register for the AXI4-Stream source interface.",
                                                inst_name='status',
                                                parent_full_inst_name='openenoc_csr.endpoint2.axis_if.source')
            self._single_register_read_and_write_test(rut=self.dut.endpoint2.axis_if.source.status, has_sw_readable=True, has_sw_writable=False,
                                                                                          readable_fields=set(['tready', ]),
                                                                                          writeable_fields=set([ ]) )
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.sink.data'):
            self._single_register_property_test(rut=self.dut.endpoint2.axis_if.sink.data, address=4144, width=32, accesswidth=32, size=4,
                                                rdl_name="csr.endpoint2.axis_if.sink.data",
                                                rdl_desc="Data register for the AXI4-Stream sink interface.",
                                                inst_name='data',
                                                parent_full_inst_name='openenoc_csr.endpoint2.axis_if.sink')
            self._single_register_read_and_write_test(rut=self.dut.endpoint2.axis_if.sink.data, has_sw_readable=True, has_sw_writable=False,
                                                                                          readable_fields=set(['tdata', ]),
                                                                                          writeable_fields=set([ ]) )
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.sink.control'):
            self._single_register_property_test(rut=self.dut.endpoint2.axis_if.sink.control, address=4148, width=32, accesswidth=32, size=4,
                                                rdl_name="csr.endpoint2.axis_if.sink.control",
                                                rdl_desc="Control register for the AXI4-Stream sink interface.",
                                                inst_name='control',
                                                parent_full_inst_name='openenoc_csr.endpoint2.axis_if.sink')
            self._single_register_read_and_write_test(rut=self.dut.endpoint2.axis_if.sink.control, has_sw_readable=False, has_sw_writable=True,
                                                                                          readable_fields=set([ ]),
                                                                                          writeable_fields=set(['tready', ]) )
        with self.subTest(msg='register: openenoc_csr.endpoint2.axis_if.sink.status'):
            self._single_register_property_test(rut=self.dut.endpoint2.axis_if.sink.status, address=4152, width=32, accesswidth=32, size=4,
                                                rdl_name="csr.endpoint2.axis_if.sink.status",
                                                rdl_desc="Status register for the AXI4-Stream sink interface.",
                                                inst_name='status',
                                                parent_full_inst_name='openenoc_csr.endpoint2.axis_if.sink')
            self._single_register_read_and_write_test(rut=self.dut.endpoint2.axis_if.sink.status, has_sw_readable=True, has_sw_writable=False,
                                                                                          readable_fields=set(['tvalid','tlast', ]),
                                                                                          writeable_fields=set([ ]) )
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[0].mac_address'):
        ...
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[0].dma'):
            self._single_register_property_test(rut=self.dut.endpoint2.peers.entry[0].dma, address=4184, width=32, accesswidth=32, size=4,
                                                rdl_name="csr.endpoint2.peers.entry[0..NUM_OF_PEERS-1].dma",
                                                rdl_desc="DMA configuration and control for the remote peer.",
                                                inst_name='dma',
                                                parent_full_inst_name='openenoc_csr.endpoint2.peers.entry[0]')
            self._single_register_read_and_write_test(rut=self.dut.endpoint2.peers.entry[0].dma, has_sw_readable=True, has_sw_writable=True,
        ...
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[1].size'):
            ...
            self._single_register_read_and_write_test(rut=self.dut.endpoint2.peers.entry[1].register_size, has_sw_readable=True, has_sw_writable=True,
                                                                                          ...
                                                                                          writeable_fields=set(['bytes', ]) )
        with self.subTest(msg='register: openenoc_csr.endpoint2.peers.entry[1].dma'):
            self._single_register_property_test(rut=self.dut.endpoint2.peers.entry[1].dma, address=4212, width=32, accesswidth=32, size=4,
                                                rdl_name="csr.endpoint2.peers.entry[0..NUM_OF_PEERS-1].dma",
                                                rdl_desc="DMA configuration and control for the remote peer.",
                                                inst_name='dma',
                                                parent_full_inst_name='openenoc_csr.endpoint2.peers.entry[1]')
            self._single_register_read_and_write_test(rut=self.dut.endpoint2.peers.entry[1].dma, has_sw_readable=True, has_sw_writable=True,
                                                                                          readable_fields=set(['mode','request','idle','done','error', ]),
                                                                                          writeable_fields=set(['mode','request', ]) )
    ...
    def test_field(self) -> None:
        ...
        with self.subTest(msg='field: openenoc_csr.endpoint2.info.rmem_total_depth'):
            self._single_field_property_test(fut=self.dut.endpoint2.info.rmem_total_depth, lsb=0, msb=31, low=0, high=31, is_volatile=False, default=128,
        ...
        with self.subTest(msg='field: openenoc_csr.endpoint2.info.num_of_peers'):
            self._single_field_property_test(fut=self.dut.endpoint2.info.num_of_peers, lsb=32, msb=63, low=32, high=63, is_volatile=False, default=2,
        ...
        with self.subTest(msg='field: openenoc_csr.endpoint2.axis_if.source.data.tdata'):
            self._single_field_property_test(fut=self.dut.endpoint2.axis_if.source.data.tdata, lsb=0, msb=31, low=0, high=31, is_volatile=False, default=0,
                                             rdl_name="csr.endpoint2.axis_if.source.data.tdata[31:0]",
                                             rdl_desc="32-bit data value for the AXI4-Stream source interface.",
                                             inst_name='tdata',
                                             parent_full_inst_name='openenoc_csr.endpoint2.axis_if.source.data')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.axis_if.source.data.tdata, is_sw_readable=True, is_sw_writable=True)
        with self.subTest(msg='field: openenoc_csr.endpoint2.axis_if.source.control.tvalid'):
            self._single_field_property_test(fut=self.dut.endpoint2.axis_if.source.control.tvalid, lsb=0, msb=0, low=0, high=0, is_volatile=False, default=0,
                                             rdl_name="csr.endpoint2.axis_if.source.control.tvalid",
                                             ...
                                             inst_name='tvalid',
                                             parent_full_inst_name='openenoc_csr.endpoint2.axis_if.source.control')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.axis_if.source.control.tvalid, is_sw_readable=True, is_sw_writable=True)
        with self.subTest(msg='field: openenoc_csr.endpoint2.axis_if.source.control.tlast'):
            self._single_field_property_test(fut=self.dut.endpoint2.axis_if.source.control.tlast, lsb=8, msb=8, low=8, high=8, is_volatile=False, default=0,
                                             rdl_name="csr.endpoint2.axis_if.source.control.tlast",
                                             rdl_desc="Indicates the last data word of a frame on the AXI4-Stream source interface.",
                                             inst_name='tlast',
                                             parent_full_inst_name='openenoc_csr.endpoint2.axis_if.source.control')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.axis_if.source.control.tlast, is_sw_readable=True, is_sw_writable=True)
        with self.subTest(msg='field: openenoc_csr.endpoint2.axis_if.source.status.tready'):
            self._single_field_property_test(fut=self.dut.endpoint2.axis_if.source.status.tready, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=0,
                                             rdl_name="csr.endpoint2.axis_if.source.status.tready",
                                             rdl_desc="Indicates that the destination AXI4-Stream interface is ready to receive data.",
                                             inst_name='tready',
                                             parent_full_inst_name='openenoc_csr.endpoint2.axis_if.source.status')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.axis_if.source.status.tready, is_sw_readable=True, is_sw_writable=False)
        with self.subTest(msg='field: openenoc_csr.endpoint2.axis_if.sink.data.tdata'):
            self._single_field_property_test(fut=self.dut.endpoint2.axis_if.sink.data.tdata, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             rdl_name="csr.endpoint2.axis_if.sink.data.tdata[31:0]",
                                             rdl_desc="32-bit data value for the AXI4-Stream sink interface.",
                                             inst_name='tdata',
                                             parent_full_inst_name='openenoc_csr.endpoint2.axis_if.sink.data')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.axis_if.sink.data.tdata, is_sw_readable=True, is_sw_writable=False)
        with self.subTest(msg='field: openenoc_csr.endpoint2.axis_if.sink.control.tready'):
            self._single_field_property_test(fut=self.dut.endpoint2.axis_if.sink.control.tready, lsb=0, msb=0, low=0, high=0, is_volatile=False, default=0,
                                             rdl_name="csr.endpoint2.axis_if.sink.control.tready",
                                             rdl_desc="Indicates that the AXI4-Stream sink interface is ready to receive next data transfer.",
                                             inst_name='tready',
                                             parent_full_inst_name='openenoc_csr.endpoint2.axis_if.sink.control')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.axis_if.sink.control.tready, is_sw_readable=False, is_sw_writable=True)
        with self.subTest(msg='field: openenoc_csr.endpoint2.axis_if.sink.status.tvalid'):
            self._single_field_property_test(fut=self.dut.endpoint2.axis_if.sink.status.tvalid, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             rdl_name="csr.endpoint2.axis_if.sink.status.tvalid",
                                             rdl_desc="Indicates that the AXI4-Stream sink interface has valid data to receive.",
                                             inst_name='tvalid',
                                             parent_full_inst_name='openenoc_csr.endpoint2.axis_if.sink.status')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.axis_if.sink.status.tvalid, is_sw_readable=True, is_sw_writable=False)
        with self.subTest(msg='field: openenoc_csr.endpoint2.axis_if.sink.status.tlast'):
            self._single_field_property_test(fut=self.dut.endpoint2.axis_if.sink.status.tlast, lsb=8, msb=8, low=8, high=8, is_volatile=True, default=None,
                                             rdl_name="csr.endpoint2.axis_if.sink.status.tlast",
                                             rdl_desc="Indicates the last data word of a frame on the AXI4-Stream sink interface.",
                                             inst_name='tlast',
                                             parent_full_inst_name='openenoc_csr.endpoint2.axis_if.sink.status')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.axis_if.sink.status.tlast, is_sw_readable=True, is_sw_writable=False)
        ...
        with self.subTest(msg='field: openenoc_csr.endpoint2.peers.entry[0].size.bytes'):
            self._single_field_property_test(fut=self.dut.endpoint2.peers.entry[0].register_size.bytes, lsb=0, msb=31, low=0, high=31, is_volatile=False, default=None,
                                             rdl_name="csr.endpoint2.peers.entry[0..NUM_OF_PEERS-1].size.bytes[31:0]",
            ...
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.peers.entry[0].register_size.bytes, is_sw_readable=True, is_sw_writable=True)
        with self.subTest(msg='field: openenoc_csr.endpoint2.peers.entry[0].dma.mode'):
            self._single_field_property_test(fut=self.dut.endpoint2.peers.entry[0].dma.mode, lsb=0, msb=1, low=0, high=1, is_volatile=False, default=None,
                                             rdl_name="csr.endpoint2.peers.entry[0..NUM_OF_PEERS-1].dma.mode[1:0]",
                                             ...
                                             inst_name='mode',
                                             parent_full_inst_name='openenoc_csr.endpoint2.peers.entry[0].dma')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.peers.entry[0].dma.mode, is_sw_readable=True, is_sw_writable=True)
        with self.subTest(msg='field: openenoc_csr.endpoint2.peers.entry[0].dma.request'):
            self._single_field_property_test(fut=self.dut.endpoint2.peers.entry[0].dma.request, lsb=8, msb=8, low=8, high=8, is_volatile=False, default=0,
                                             rdl_name="csr.endpoint2.peers.entry[0..NUM_OF_PEERS-1].dma.request[8:8]",
                                             ...
                                             inst_name='request',
                                             parent_full_inst_name='openenoc_csr.endpoint2.peers.entry[0].dma')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.peers.entry[0].dma.request, is_sw_readable=True, is_sw_writable=True)
        with self.subTest(msg='field: openenoc_csr.endpoint2.peers.entry[0].dma.idle'):
            self._single_field_property_test(fut=self.dut.endpoint2.peers.entry[0].dma.idle, lsb=16, msb=16, low=16, high=16, is_volatile=True, default=None,
                                             rdl_name="csr.endpoint2.peers.entry[0..NUM_OF_PEERS-1].dma.idle[16:16]",
                                             ...
                                             inst_name='idle',
                                             parent_full_inst_name='openenoc_csr.endpoint2.peers.entry[0].dma')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.peers.entry[0].dma.idle, is_sw_readable=True, is_sw_writable=False)
        with self.subTest(msg='field: openenoc_csr.endpoint2.peers.entry[0].dma.done'):
            self._single_field_property_test(fut=self.dut.endpoint2.peers.entry[0].dma.done, lsb=24, msb=24, low=24, high=24, is_volatile=True, default=None,
                                             rdl_name="csr.endpoint2.peers.entry[0..NUM_OF_PEERS-1].dma.done[24:24]",
                                             ...
                                             inst_name='done',
                                             parent_full_inst_name='openenoc_csr.endpoint2.peers.entry[0].dma')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.peers.entry[0].dma.done, is_sw_readable=True, is_sw_writable=False)
        with self.subTest(msg='field: openenoc_csr.endpoint2.peers.entry[0].dma.error'):
            self._single_field_property_test(fut=self.dut.endpoint2.peers.entry[0].dma.error, lsb=25, msb=25, low=25, high=25, is_volatile=True, default=None,
                                             rdl_name="csr.endpoint2.peers.entry[0..NUM_OF_PEERS-1].dma.error[25:25]",
                                             ...
                                             inst_name='error',
                                             parent_full_inst_name='openenoc_csr.endpoint2.peers.entry[0].dma')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.peers.entry[0].dma.error, is_sw_readable=True, is_sw_writable=False)
        ...
        with self.subTest(msg='field: openenoc_csr.endpoint2.peers.entry[1].size.bytes'):
            self._single_field_property_test(fut=self.dut.endpoint2.peers.entry[1].register_size.bytes, lsb=0, msb=31, low=0, high=31, is_volatile=False, default=None,
                                             rdl_name="csr.endpoint2.peers.entry[0..NUM_OF_PEERS-1].size.bytes[31:0]",
                                             rdl_desc="32-bit size of the remote peer\u0027s memory region in bytes.",
                                             inst_name='bytes',
                                             parent_full_inst_name='openenoc_csr.endpoint2.peers.entry[1].size')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.peers.entry[1].register_size.bytes, is_sw_readable=True, is_sw_writable=True)
        with self.subTest(msg='field: openenoc_csr.endpoint2.peers.entry[1].dma.mode'):
            self._single_field_property_test(fut=self.dut.endpoint2.peers.entry[1].dma.mode, lsb=0, msb=1, low=0, high=1, is_volatile=False, default=None,
                                             rdl_name="csr.endpoint2.peers.entry[0..NUM_OF_PEERS-1].dma.mode[1:0]",
                                             rdl_desc="DMA mode for transfers to/from the remote peer:\u003cul\u003e\n\u003cli\u003e0: DMA transfers to/from the remote peer are disabled.\u003c/li\u003e\n\u003cli\u003e1: DMA transfers to/from the remote peer are enabled in transparent mode, where accesses to the virtual memory region are directly translated to corresponding accesses to the remote peer\u0027s memory region (transactions are word-by-word, i.e., per virtual memory access).\u003c/li\u003e\n\u003cli\u003e2: DMA transfers to/from the remote peer are enabled in mirror-to-local mode, where the local memory region is used instead of the virtual memory region. The state of the remote peer\u0027s memory region (remote_address, size) is fetched from the remote peer on demand or periodically.\u003c/li\u003e\n\u003cli\u003e3: DMA transfers to/from the remote peer are enabled in mirror-to-remote mode, where the remote memory region is used instead of the virtual memory region. The state of the local peer\u0027s memory region (local_address, size) is sent to the remote peer on demand or periodically.\u003c/li\u003e\n\u003c/ul\u003e",
                                             inst_name='mode',
                                             parent_full_inst_name='openenoc_csr.endpoint2.peers.entry[1].dma')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.peers.entry[1].dma.mode, is_sw_readable=True, is_sw_writable=True)
        with self.subTest(msg='field: openenoc_csr.endpoint2.peers.entry[1].dma.request'):
            self._single_field_property_test(fut=self.dut.endpoint2.peers.entry[1].dma.request, lsb=8, msb=8, low=8, high=8, is_volatile=False, default=0,
                                             rdl_name="csr.endpoint2.peers.entry[0..NUM_OF_PEERS-1].dma.request[8:8]",
                                             rdl_desc="Writing a 1 to this field initiates a DMA transfer to/from the remote peer. This field is a single-pulse register that is automatically cleared back to zero after being written.",
                                             inst_name='request',
                                             parent_full_inst_name='openenoc_csr.endpoint2.peers.entry[1].dma')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.peers.entry[1].dma.request, is_sw_readable=True, is_sw_writable=True)
        with self.subTest(msg='field: openenoc_csr.endpoint2.peers.entry[1].dma.idle'):
            self._single_field_property_test(fut=self.dut.endpoint2.peers.entry[1].dma.idle, lsb=16, msb=16, low=16, high=16, is_volatile=True, default=None,
                                             rdl_name="csr.endpoint2.peers.entry[0..NUM_OF_PEERS-1].dma.idle[16:16]",
                                             rdl_desc="Indicates whether the DMA transfer to/from the remote peer is idle. A value of 1 indicates that the DMA transfer is idle, while a value of 0 indicates that the DMA transfer is in progress.",
                                             inst_name='idle',
                                             parent_full_inst_name='openenoc_csr.endpoint2.peers.entry[1].dma')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.peers.entry[1].dma.idle, is_sw_readable=True, is_sw_writable=False)
        with self.subTest(msg='field: openenoc_csr.endpoint2.peers.entry[1].dma.done'):
            self._single_field_property_test(fut=self.dut.endpoint2.peers.entry[1].dma.done, lsb=24, msb=24, low=24, high=24, is_volatile=True, default=None,
                                             rdl_name="csr.endpoint2.peers.entry[0..NUM_OF_PEERS-1].dma.done[24:24]",
                                             rdl_desc="Indicates whether the DMA transfer to/from the remote peer has been successful. A value of 1 indicates that the DMA transfer has completed successfully, while a value of 0 indicates that the DMA transfer is still in progress or has encountered an error.",
                                             inst_name='done',
                                             parent_full_inst_name='openenoc_csr.endpoint2.peers.entry[1].dma')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.peers.entry[1].dma.done, is_sw_readable=True, is_sw_writable=False)
        with self.subTest(msg='field: openenoc_csr.endpoint2.peers.entry[1].dma.error'):
            self._single_field_property_test(fut=self.dut.endpoint2.peers.entry[1].dma.error, lsb=25, msb=25, low=25, high=25, is_volatile=True, default=None,
                                             rdl_name="csr.endpoint2.peers.entry[0..NUM_OF_PEERS-1].dma.error[25:25]",
                                             rdl_desc="Indicates whether the DMA transfer to/from the remote peer has encountered an error. A value of 1 indicates an error, while a value of 0 indicates no error.",
                                             inst_name='error',
                                             parent_full_inst_name='openenoc_csr.endpoint2.peers.entry[1].dma')
            self._single_int_field_read_and_write_test(fut=self.dut.endpoint2.peers.entry[1].dma.error, is_sw_readable=True, is_sw_writable=False)
    ...
    def test_regfile(self) -> None:
        ...
        with self.subTest(msg='regfile: openenoc_csr.endpoint2.axis_if'):
            self._single_regfile_property_test(dut=self.dut.endpoint2.axis_if,
                                               size=28,
                                               rdl_name="csr.endpoint2.axis_if",
                                               rdl_desc="Register file for the AXI4-Stream source and sink interfaces.",
                                               inst_name='axis_if',
                                               parent_full_inst_name='openenoc_csr.endpoint2')
            self._test_regfile_iterators(dut=self.dut.endpoint2.axis_if,
                                         writeable_registers=NodeIterators(),
                                         readable_registers=NodeIterators(),
                                         sections=NodeIterators('source','sink',))
        with self.subTest(msg='regfile: openenoc_csr.endpoint2.axis_if.source'):
            self._single_regfile_property_test(dut=self.dut.endpoint2.axis_if.source,
                                               size=12,
                                               rdl_name="csr.endpoint2.axis_if.source",
                                               rdl_desc="Register file for the AXI4-Stream source interface.",
                                               inst_name='source',
                                               parent_full_inst_name='openenoc_csr.endpoint2.axis_if')
            self._test_regfile_iterators(dut=self.dut.endpoint2.axis_if.source,
                                         writeable_registers=NodeIterators('data','control',),
                                         readable_registers=NodeIterators('data','control','status',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: openenoc_csr.endpoint2.axis_if.sink'):
            self._single_regfile_property_test(dut=self.dut.endpoint2.axis_if.sink,
                                               size=12,
                                               rdl_name="csr.endpoint2.axis_if.sink",
                                               rdl_desc="Register file for the AXI4-Stream sink interface.",
                                               inst_name='sink',
                                               parent_full_inst_name='openenoc_csr.endpoint2.axis_if')
            self._test_regfile_iterators(dut=self.dut.endpoint2.axis_if.sink,
