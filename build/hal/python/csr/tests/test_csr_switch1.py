...
class csr_switch1_single_access(csr_TestCase): # type: ignore[valid-type,misc]
    ...
    def test_user_defined_properties(self)  -> None:
        ...
        """
        with self.subTest(msg='register: csr.switch1.forwarding_table'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[0]'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[0].udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[1]'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[1].udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[2]'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[2].udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[3]'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[3].udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[4]'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[4].udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[5]'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[5].udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[6]'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[6].udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[7]'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[7].udp,{})
            
        with self.subTest(msg='register: csr.switch1.info'):
            
            
            self.assertDictEqual(self.dut.switch1.info.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_control'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_control.udp,{})
            
        with self.subTest(msg='register: csr.switch1.default_forwarding'):
            
            
            self.assertDictEqual(self.dut.switch1.default_forwarding.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[0].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[0].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[0].iface'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[0].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[0].config'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[0].config.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[1].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[1].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[1].iface'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[1].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[1].config'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[1].config.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[2].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[2].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[2].iface'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[2].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[2].config'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[2].config.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[3].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[3].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[3].iface'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[3].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[3].config'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[3].config.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[4].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[4].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[4].iface'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[4].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[4].config'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[4].config.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[5].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[5].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[5].iface'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[5].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[5].config'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[5].config.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[6].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[6].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[6].iface'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[6].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[6].config'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[6].config.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[7].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[7].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[7].iface'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[7].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[7].config'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[7].config.udp,{})
            
        with self.subTest(msg='register: csr.switch1.info.table_depth'):
            
            
            self.assertDictEqual(self.dut.switch1.info.table_depth.udp,{})
            
        with self.subTest(msg='register: csr.switch1.info.num_of_interfaces'):
            
            
            self.assertDictEqual(self.dut.switch1.info.num_of_interfaces.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_control.operation_mode'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_control.operation_mode.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_control.pause_request'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_control.pause_request.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_control.pause_done'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_control.pause_done.udp,{})
            
        with self.subTest(msg='register: csr.switch1.default_forwarding.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch1.default_forwarding.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[0].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[0].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[0].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[0].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[0].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[0].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[0].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[0].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[1].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[1].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[1].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[1].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[1].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[1].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[1].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[1].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[2].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[2].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[2].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[2].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[2].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[2].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[2].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[2].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[3].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[3].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[3].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[3].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[3].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[3].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[3].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[3].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[4].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[4].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[4].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[4].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[4].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[4].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[4].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[4].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[5].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[5].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[5].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[5].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[5].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[5].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[5].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[5].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[6].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[6].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[6].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[6].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[6].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[6].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[6].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[6].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[7].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[7].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[7].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[7].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[7].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch1.forwarding_table.entry[7].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[7].config.enabled'):
    ...
    def test_register(self) -> None:
        ...
        with self.subTest(msg='register: csr.switch1.info'):
            self._single_register_property_test(rut=self.dut.switch1.info, address=256, width=32, accesswidth=32, size=4,
                                                ...
                                                inst_name='info',
                                                parent_full_inst_name='csr.switch1')
        ...
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[0].macaddr'):
            self._single_register_property_test(rut=self.dut.switch1.forwarding_table.entry[0].macaddr, address=384, width=64, accesswidth=32, size=8,
                                                ...
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch1.forwarding_table.entry[0]')
        ...
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[1].macaddr'):
            self._single_register_property_test(rut=self.dut.switch1.forwarding_table.entry[1].macaddr, address=400, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch1.forwarding_table.entry[1]')
        ...
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[2].macaddr'):
            self._single_register_property_test(rut=self.dut.switch1.forwarding_table.entry[2].macaddr, address=416, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch1.forwarding_table.entry[2]')
        ...
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[3].macaddr'):
            self._single_register_property_test(rut=self.dut.switch1.forwarding_table.entry[3].macaddr, address=432, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch1.forwarding_table.entry[3]')
        ...
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[4].macaddr'):
            self._single_register_property_test(rut=self.dut.switch1.forwarding_table.entry[4].macaddr, address=448, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch1.forwarding_table.entry[4]')
        ...
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[5].macaddr'):
            self._single_register_property_test(rut=self.dut.switch1.forwarding_table.entry[5].macaddr, address=464, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch1.forwarding_table.entry[5]')
        ...
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[6].macaddr'):
            self._single_register_property_test(rut=self.dut.switch1.forwarding_table.entry[6].macaddr, address=480, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch1.forwarding_table.entry[6]')
        ...
        with self.subTest(msg='register: csr.switch1.forwarding_table.entry[7].macaddr'):
            self._single_register_property_test(rut=self.dut.switch1.forwarding_table.entry[7].macaddr, address=496, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch1.forwarding_table.entry[7]')
    ...
    def test_field(self) -> None:
        ...
        with self.subTest(msg='field: csr.switch1.info.table_depth'):
            self._single_field_property_test(fut=self.dut.switch1.info.table_depth, lsb=0, msb=15, low=0, high=15, is_volatile=False, default=8,
                                             ...
                                             parent_full_inst_name='csr.switch1.info')
        ...
        with self.subTest(msg='field: csr.switch1.info.num_of_interfaces'):
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_control.operation_mode'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_control.operation_mode, lsb=0, msb=0, low=0, high=0, is_volatile=False, default=0,
                                             ...
                                             parent_full_inst_name='csr.switch1.forwarding_control')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_control.pause_request'):
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_control.pause_done'):
        ...
        with self.subTest(msg='field: csr.switch1.default_forwarding.bitmap'):
            self._single_field_property_test(fut=self.dut.switch1.default_forwarding.bitmap, lsb=0, msb=3, low=0, high=3, is_volatile=False, default=0,
                                             ...
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch1.default_forwarding')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[0].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[0].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[0].macaddr')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[0].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[0].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[0].iface.bitmap, lsb=0, msb=3, low=0, high=3, is_volatile=True, default=None,
                                             ...
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[0].iface')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[0].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[0].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[0].config')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[1].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[1].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[1].macaddr')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[1].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[1].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[1].iface.bitmap, lsb=0, msb=3, low=0, high=3, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[1].iface')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[1].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[1].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[1].config')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[2].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[2].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[2].macaddr')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[2].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[2].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[2].iface.bitmap, lsb=0, msb=3, low=0, high=3, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[2].iface')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[2].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[2].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[2].config')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[3].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[3].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[3].macaddr')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[3].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[3].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[3].iface.bitmap, lsb=0, msb=3, low=0, high=3, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[3].iface')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[3].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[3].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[3].config')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[4].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[4].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[4].macaddr')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[4].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[4].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[4].iface.bitmap, lsb=0, msb=3, low=0, high=3, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[4].iface')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[4].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[4].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[4].config')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[5].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[5].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[5].macaddr')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[5].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[5].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[5].iface.bitmap, lsb=0, msb=3, low=0, high=3, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[5].iface')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[5].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[5].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[5].config')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[6].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[6].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[6].macaddr')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[6].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[6].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[6].iface.bitmap, lsb=0, msb=3, low=0, high=3, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[6].iface')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[6].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[6].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[6].config')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[7].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[7].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[7].macaddr')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[7].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[7].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[7].iface.bitmap, lsb=0, msb=3, low=0, high=3, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[7].iface')
        ...
        with self.subTest(msg='field: csr.switch1.forwarding_table.entry[7].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch1.forwarding_table.entry[7].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch1.forwarding_table.entry[7].config')
    ...
    def test_regfile(self) -> None:
        ...
        with self.subTest(msg='regfile: csr.switch1.forwarding_table'):
        ...
        with self.subTest(msg='regfile: csr.switch1.forwarding_table.entry[0]'):
            self._single_regfile_property_test(dut=self.dut.switch1.forwarding_table.entry[0],
                                               ...
                                               inst_name='entry[0]',
                                               parent_full_inst_name='csr.switch1.forwarding_table')
        ...
        with self.subTest(msg='regfile: csr.switch1.forwarding_table.entry[1]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch1.forwarding_table.entry[1],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch1.forwarding_table.entry[2]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch1.forwarding_table.entry[2],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch1.forwarding_table.entry[3]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch1.forwarding_table.entry[3],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch1.forwarding_table.entry[4]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch1.forwarding_table.entry[4],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch1.forwarding_table.entry[5]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch1.forwarding_table.entry[5],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch1.forwarding_table.entry[6]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch1.forwarding_table.entry[6],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch1.forwarding_table.entry[7]'):
    ...
    def test_array_slicing(self) -> None:
        ...
        with self.subTest(msg='hidden_node: csr.switch1.forwarding_table.entry[]'):
...
class csr_switch1_block_access(csr_TestCase_BlockAccess): # type: ignore[valid-type,misc]
    """
...
class csr_switch1_alt_block_access(csr_TestCase_AltBlockAccess): # type: ignore[valid-type,misc]
    """
