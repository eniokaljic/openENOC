...
class csr_switch2_single_access(csr_TestCase): # type: ignore[valid-type,misc]
    ...
    def test_user_defined_properties(self)  -> None:
        ...
        """
        with self.subTest(msg='register: csr.switch2.forwarding_table'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[0]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[0].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[1]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[1].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[2]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[2].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[3]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[3].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[4]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[4].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[5]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[5].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[6]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[6].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[7]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[7].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[8]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[8].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[9]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[9].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[10]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[10].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[11]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[11].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[12]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[12].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[13]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[13].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[14]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[14].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[15]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[15].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[16]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[16].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[17]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[17].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[18]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[18].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[19]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[19].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[20]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[20].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[21]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[21].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[22]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[22].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[23]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[23].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[24]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[24].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[25]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[25].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[26]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[26].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[27]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[27].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[28]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[28].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[29]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[29].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[30]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[30].udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[31]'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[31].udp,{})
            
        with self.subTest(msg='register: csr.switch2.info'):
            
            
            self.assertDictEqual(self.dut.switch2.info.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_control'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_control.udp,{})
            
        with self.subTest(msg='register: csr.switch2.default_forwarding'):
            
            
            self.assertDictEqual(self.dut.switch2.default_forwarding.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[0].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[0].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[0].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[0].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[0].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[0].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[1].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[1].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[1].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[1].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[1].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[1].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[2].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[2].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[2].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[2].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[2].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[2].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[3].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[3].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[3].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[3].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[3].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[3].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[4].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[4].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[4].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[4].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[4].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[4].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[5].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[5].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[5].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[5].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[5].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[5].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[6].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[6].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[6].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[6].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[6].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[6].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[7].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[7].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[7].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[7].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[7].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[7].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[8].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[8].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[8].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[8].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[8].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[8].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[9].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[9].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[9].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[9].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[9].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[9].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[10].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[10].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[10].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[10].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[10].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[10].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[11].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[11].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[11].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[11].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[11].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[11].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[12].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[12].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[12].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[12].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[12].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[12].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[13].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[13].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[13].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[13].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[13].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[13].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[14].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[14].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[14].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[14].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[14].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[14].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[15].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[15].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[15].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[15].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[15].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[15].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[16].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[16].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[16].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[16].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[16].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[16].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[17].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[17].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[17].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[17].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[17].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[17].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[18].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[18].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[18].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[18].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[18].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[18].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[19].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[19].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[19].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[19].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[19].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[19].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[20].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[20].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[20].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[20].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[20].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[20].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[21].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[21].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[21].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[21].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[21].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[21].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[22].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[22].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[22].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[22].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[22].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[22].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[23].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[23].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[23].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[23].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[23].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[23].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[24].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[24].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[24].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[24].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[24].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[24].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[25].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[25].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[25].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[25].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[25].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[25].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[26].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[26].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[26].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[26].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[26].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[26].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[27].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[27].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[27].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[27].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[27].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[27].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[28].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[28].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[28].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[28].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[28].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[28].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[29].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[29].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[29].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[29].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[29].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[29].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[30].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[30].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[30].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[30].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[30].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[30].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[31].macaddr'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[31].macaddr.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[31].iface'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[31].iface.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[31].config'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[31].config.udp,{})
            
        with self.subTest(msg='register: csr.switch2.info.table_depth'):
            
            
            self.assertDictEqual(self.dut.switch2.info.table_depth.udp,{})
            
        with self.subTest(msg='register: csr.switch2.info.num_of_interfaces'):
            
            
            self.assertDictEqual(self.dut.switch2.info.num_of_interfaces.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_control.operation_mode'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_control.operation_mode.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_control.pause_request'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_control.pause_request.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_control.pause_done'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_control.pause_done.udp,{})
            
        with self.subTest(msg='register: csr.switch2.default_forwarding.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.default_forwarding.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[0].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[0].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[0].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[0].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[0].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[0].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[0].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[0].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[1].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[1].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[1].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[1].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[1].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[1].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[1].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[1].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[2].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[2].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[2].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[2].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[2].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[2].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[2].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[2].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[3].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[3].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[3].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[3].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[3].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[3].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[3].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[3].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[4].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[4].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[4].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[4].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[4].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[4].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[4].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[4].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[5].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[5].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[5].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[5].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[5].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[5].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[5].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[5].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[6].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[6].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[6].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[6].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[6].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[6].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[6].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[6].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[7].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[7].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[7].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[7].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[7].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[7].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[7].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[7].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[8].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[8].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[8].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[8].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[8].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[8].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[8].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[8].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[9].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[9].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[9].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[9].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[9].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[9].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[9].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[9].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[10].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[10].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[10].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[10].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[10].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[10].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[10].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[10].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[11].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[11].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[11].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[11].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[11].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[11].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[11].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[11].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[12].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[12].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[12].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[12].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[12].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[12].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[12].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[12].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[13].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[13].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[13].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[13].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[13].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[13].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[13].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[13].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[14].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[14].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[14].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[14].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[14].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[14].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[14].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[14].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[15].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[15].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[15].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[15].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[15].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[15].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[15].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[15].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[16].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[16].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[16].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[16].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[16].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[16].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[16].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[16].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[17].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[17].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[17].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[17].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[17].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[17].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[17].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[17].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[18].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[18].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[18].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[18].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[18].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[18].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[18].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[18].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[19].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[19].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[19].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[19].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[19].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[19].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[19].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[19].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[20].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[20].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[20].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[20].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[20].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[20].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[20].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[20].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[21].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[21].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[21].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[21].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[21].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[21].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[21].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[21].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[22].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[22].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[22].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[22].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[22].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[22].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[22].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[22].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[23].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[23].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[23].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[23].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[23].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[23].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[23].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[23].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[24].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[24].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[24].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[24].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[24].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[24].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[24].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[24].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[25].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[25].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[25].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[25].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[25].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[25].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[25].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[25].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[26].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[26].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[26].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[26].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[26].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[26].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[26].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[26].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[27].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[27].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[27].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[27].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[27].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[27].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[27].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[27].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[28].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[28].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[28].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[28].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[28].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[28].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[28].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[28].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[29].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[29].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[29].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[29].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[29].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[29].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[29].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[29].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[30].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[30].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[30].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[30].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[30].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[30].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[30].config.enabled'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[30].config.enabled.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[31].macaddr.lo_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[31].macaddr.lo_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[31].macaddr.hi_word'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[31].macaddr.hi_word.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[31].iface.bitmap'):
            
            
            self.assertDictEqual(self.dut.switch2.forwarding_table.entry[31].iface.bitmap.udp,{})
            
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[31].config.enabled'):
    ...
    def test_register(self) -> None:
        ...
        with self.subTest(msg='register: csr.switch2.info'):
            self._single_register_property_test(rut=self.dut.switch2.info, address=1024, width=32, accesswidth=32, size=4,
                                                ...
                                                inst_name='info',
                                                parent_full_inst_name='csr.switch2')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[0].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[0].macaddr, address=1536, width=64, accesswidth=32, size=8,
                                                ...
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[0]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[1].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[1].macaddr, address=1552, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[1]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[2].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[2].macaddr, address=1568, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[2]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[3].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[3].macaddr, address=1584, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[3]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[4].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[4].macaddr, address=1600, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[4]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[5].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[5].macaddr, address=1616, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[5]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[6].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[6].macaddr, address=1632, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[6]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[7].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[7].macaddr, address=1648, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[7]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[8].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[8].macaddr, address=1664, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[8]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[9].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[9].macaddr, address=1680, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[9]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[10].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[10].macaddr, address=1696, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[10]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[11].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[11].macaddr, address=1712, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[11]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[12].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[12].macaddr, address=1728, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[12]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[13].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[13].macaddr, address=1744, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[13]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[14].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[14].macaddr, address=1760, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[14]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[15].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[15].macaddr, address=1776, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[15]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[16].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[16].macaddr, address=1792, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[16]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[17].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[17].macaddr, address=1808, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[17]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[18].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[18].macaddr, address=1824, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[18]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[19].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[19].macaddr, address=1840, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[19]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[20].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[20].macaddr, address=1856, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[20]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[21].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[21].macaddr, address=1872, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[21]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[22].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[22].macaddr, address=1888, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[22]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[23].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[23].macaddr, address=1904, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[23]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[24].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[24].macaddr, address=1920, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[24]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[25].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[25].macaddr, address=1936, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[25]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[26].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[26].macaddr, address=1952, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[26]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[27].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[27].macaddr, address=1968, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[27]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[28].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[28].macaddr, address=1984, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[28]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[29].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[29].macaddr, address=2000, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[29]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[30].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[30].macaddr, address=2016, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[30]')
        ...
        with self.subTest(msg='register: csr.switch2.forwarding_table.entry[31].macaddr'):
            self._single_register_property_test(rut=self.dut.switch2.forwarding_table.entry[31].macaddr, address=2032, width=64, accesswidth=32, size=8,
                                                ...
                                                rdl_desc="48-bit destination MAC address used as the key for this forwarding table entry.",
                                                inst_name='macaddr',
                                                parent_full_inst_name='csr.switch2.forwarding_table.entry[31]')
    ...
    def test_field(self) -> None:
        ...
        with self.subTest(msg='field: csr.switch2.info.table_depth'):
            self._single_field_property_test(fut=self.dut.switch2.info.table_depth, lsb=0, msb=15, low=0, high=15, is_volatile=False, default=32,
                                             ...
                                             parent_full_inst_name='csr.switch2.info')
        ...
        with self.subTest(msg='field: csr.switch2.info.num_of_interfaces'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_control.operation_mode'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_control.operation_mode, lsb=0, msb=0, low=0, high=0, is_volatile=False, default=0,
                                             ...
                                             parent_full_inst_name='csr.switch2.forwarding_control')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_control.pause_request'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_control.pause_done'):
        ...
        with self.subTest(msg='field: csr.switch2.default_forwarding.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.default_forwarding.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=False, default=0,
                                             ...
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.default_forwarding')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[0].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[0].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[0].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[0].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[0].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[0].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[0].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[0].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[0].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[0].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[1].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[1].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[1].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[1].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[1].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[1].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[1].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[1].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[1].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[1].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[2].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[2].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[2].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[2].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[2].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[2].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[2].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[2].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[2].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[2].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[3].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[3].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[3].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[3].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[3].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[3].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[3].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[3].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[3].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[3].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[4].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[4].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[4].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[4].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[4].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[4].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[4].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[4].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[4].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[4].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[5].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[5].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[5].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[5].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[5].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[5].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[5].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[5].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[5].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[5].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[6].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[6].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[6].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[6].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[6].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[6].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[6].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[6].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[6].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[6].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[7].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[7].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[7].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[7].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[7].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[7].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[7].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[7].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[7].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[7].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[8].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[8].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[8].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[8].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[8].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[8].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[8].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[8].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[8].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[8].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[9].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[9].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[9].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[9].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[9].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[9].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[9].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[9].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[9].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[9].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[10].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[10].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[10].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[10].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[10].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[10].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[10].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[10].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[10].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[10].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[11].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[11].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[11].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[11].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[11].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[11].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[11].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[11].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[11].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[11].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[12].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[12].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[12].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[12].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[12].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[12].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[12].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[12].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[12].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[12].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[13].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[13].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[13].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[13].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[13].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[13].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[13].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[13].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[13].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[13].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[14].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[14].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[14].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[14].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[14].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[14].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[14].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[14].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[14].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[14].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[15].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[15].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[15].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[15].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[15].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[15].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[15].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[15].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[15].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[15].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[16].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[16].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[16].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[16].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[16].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[16].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[16].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[16].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[16].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[16].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[17].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[17].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[17].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[17].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[17].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[17].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[17].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[17].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[17].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[17].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[18].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[18].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[18].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[18].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[18].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[18].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[18].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[18].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[18].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[18].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[19].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[19].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[19].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[19].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[19].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[19].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[19].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[19].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[19].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[19].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[20].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[20].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[20].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[20].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[20].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[20].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[20].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[20].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[20].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[20].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[21].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[21].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[21].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[21].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[21].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[21].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[21].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[21].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[21].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[21].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[22].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[22].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[22].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[22].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[22].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[22].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[22].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[22].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[22].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[22].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[23].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[23].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[23].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[23].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[23].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[23].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[23].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[23].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[23].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[23].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[24].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[24].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[24].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[24].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[24].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[24].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[24].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[24].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[24].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[24].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[25].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[25].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[25].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[25].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[25].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[25].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[25].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[25].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[25].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[25].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[26].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[26].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[26].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[26].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[26].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[26].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[26].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[26].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[26].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[26].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[27].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[27].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[27].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[27].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[27].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[27].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[27].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[27].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[27].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[27].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[28].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[28].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[28].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[28].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[28].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[28].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[28].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[28].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[28].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[28].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[29].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[29].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[29].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[29].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[29].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[29].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[29].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[29].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[29].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[29].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[30].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[30].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[30].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[30].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[30].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[30].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[30].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[30].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[30].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[30].config')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[31].macaddr.lo_word'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[31].macaddr.lo_word, lsb=0, msb=31, low=0, high=31, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Lower 32 bits [31:0] of the 48-bit MAC address stored in this forwarding table entry.",
                                             inst_name='lo_word',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[31].macaddr')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[31].macaddr.hi_word'):
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[31].iface.bitmap'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[31].iface.bitmap, lsb=0, msb=7, low=0, high=7, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Bitmap selecting the output interface or interfaces to which a matching frame is forwarded. Bit NUM_OF_INTERFACES-1, the MSB, corresponds to the first interface; bit 0 corresponds to the last interface.",
                                             inst_name='bitmap',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[31].iface')
        ...
        with self.subTest(msg='field: csr.switch2.forwarding_table.entry[31].config.enabled'):
            self._single_field_property_test(fut=self.dut.switch2.forwarding_table.entry[31].config.enabled, lsb=0, msb=0, low=0, high=0, is_volatile=True, default=None,
                                             ...
                                             rdl_desc="Enables this forwarding table entry. When cleared, the entry is ignored during forwarding table lookup.",
                                             inst_name='enabled',
                                             parent_full_inst_name='csr.switch2.forwarding_table.entry[31].config')
    ...
    def test_regfile(self) -> None:
        ...
        with self.subTest(msg='regfile: csr.switch2.forwarding_table'):
        ...
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[0]'):
            self._single_regfile_property_test(dut=self.dut.switch2.forwarding_table.entry[0],
                                               ...
                                               inst_name='entry[0]',
                                               parent_full_inst_name='csr.switch2.forwarding_table')
        ...
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[1]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[1],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[2]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[2],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[3]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[3],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[4]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[4],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[5]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[5],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[6]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[6],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[7]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[7],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[8]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[8],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[9]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[9],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[10]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[10],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[11]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[11],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[12]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[12],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[13]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[13],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[14]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[14],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[15]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[15],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[16]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[16],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[17]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[17],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[18]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[18],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[19]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[19],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[20]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[20],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[21]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[21],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[22]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[22],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[23]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[23],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[24]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[24],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[25]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[25],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[26]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[26],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[27]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[27],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[28]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[28],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[29]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[29],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[30]'):
            ...
            self._test_regfile_iterators(dut=self.dut.switch2.forwarding_table.entry[30],
                                         ...
                                         readable_registers=NodeIterators('macaddr','iface','config',),
                                         sections=NodeIterators())
        with self.subTest(msg='regfile: csr.switch2.forwarding_table.entry[31]'):
    ...
    def test_array_slicing(self) -> None:
        ...
        with self.subTest(msg='hidden_node: csr.switch2.forwarding_table.entry[]'):
...
class csr_switch2_block_access(csr_TestCase_BlockAccess): # type: ignore[valid-type,misc]
    """
...
class csr_switch2_alt_block_access(csr_TestCase_AltBlockAccess): # type: ignore[valid-type,misc]
    """
