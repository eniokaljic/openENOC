...
// Generated from openenoc_full_endpoint.rdl. Do not edit.

`resetall
`timescale 1ns / 1ps
`default_nettype none

module openenoc_full_endpoint_csr_bridge (
    input  openenoc_full_endpoint_csr_pkg::openenoc_full_endpoint_csr__out_t csr_hwif_out,
    output var openenoc_full_endpoint_csr_pkg::openenoc_full_endpoint_csr__in_t csr_hwif_in,
