...
def test_openenoc_full_endpoint(request):
    ...
    verilog_sources = [
        os.path.join(hal_rtl_dir, "openenoc_full_endpoint_pkg.sv"),
        os.path.join(hal_rtl_dir, "openenoc_full_endpoint_csr_pkg.sv"),
        ...
        os.path.join(hal_rtl_dir, "openenoc_full_endpoint_csr.sv"),
        os.path.join(endpoint_dir, "openenoc_full_endpoint.sv"),
